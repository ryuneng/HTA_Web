...
<title>Bootstrap Day1 - 20231229</title>
</head>
<body>
<!-- 
	컨테이너(.container 혹은 .container-fluid)
		...
		+ 부트스트랩으로 구성된 화면에는 항상 최외곽에
		  .container 혹은 .container-fluid가 클래스 속성이 적용된 div가 위치해야 한다.
		+ 부트스트랩에서 제공하는 그리드시스템(레이아웃 구성을 지원한다.)이 적용되기 위해서 필요하다.
 -->
	<div class="container">
	  @@@@@@@ container : 화면 중앙 위치 @@@@@@@ <br>
