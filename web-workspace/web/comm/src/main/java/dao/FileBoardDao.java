...
public class FileBoardDao {
	 ...
	 * @throws SQLException
	 */
	public FileBoard getFileBoardsByNo(int no) throws SQLException {
		return (FileBoard) ibatis.queryForObject("file-boards.getFileBoardsByNo", no);
	}
}
