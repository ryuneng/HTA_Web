...
<title>커뮤니티::게시글 상세</title> <!-- 20240108 -->
</head>
<body>
...
<%
	...
	*/
	...
	// COMM_BOARD_REPLIES에 대한 CURD 기능을 제공하는 ReplyDao 객체 생성
...
%>
	...
	<div class="row">
		<div class="col-12">
			<form class="boarder bg-light p-3 mb-3"
				  method="post"
				  action="insertReply.jsp">
				<input type="hidden" name="boardNo" value="<%=no%>"> <!-- hidden : 폼이 제출될 때 같이 제출되게 할 값(겉으로 보이진 않음) -->
...
%>
			<div class="card mb-3">
				<div class="card-header">
					...
					<small><%=DateUtils.toText(reply.getCreateDate()) %></small>
