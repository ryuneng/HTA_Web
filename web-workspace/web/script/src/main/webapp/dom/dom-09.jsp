...
<div class="container">
	<div class="row">
		<div class="col-12">
			<h1 class="mt-3 mb-3">이벤트에 대한 엘리먼트의 기본동작 막기</h1>
			<!-- 
			 ...
			 <h3 class="mb-3">form태그의 submit이벤트에 대한 기본동작 막기</h3>
			 ...
			 <form method="get" action="search.jsp" onsubmit="checkForm(event)">
			 	...
			 	<button type="submit">검색</button> <!-- submit의 경우에는 button에 이벤트를 거는 게 아니라 form에 걸어야 함 -->
			 </form>
		</div>
	</div>
</div>
<script type="text/javascript">
	/*
		...
		* DOMTokenList : 문자열을 여러 개 저장하고 있는 객체(배열과 유사한 객체)
		* DOMTokenList 객체의 주요 메소드
			...
			toggle("텍스트")
				...
				존재하면 삭제하고, 없으면 추가한다.
			contains("텍스트")
				DOMTokenList객체에 지정된 텍스트가 존재하면 true, 존재하지 않으면 false를 반환한다.
	*/
